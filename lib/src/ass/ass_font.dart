...
import '../../freetype/freetype_dart.dart';
...
void setFontMetrics(FreetypeBinding ft, FT_Face face) {
  final os2Ptr =
      ft.FT_Get_Sfnt_Table(face, FT_Sfnt_Tag_.FT_SFNT_OS2) as Pointer<TT_OS2>?;
  if (os2Ptr != null) {
...
void assFaceSetSize(FreetypeBinding ft, FT_Face face, double size) {
  final req = calloc<FT_Size_RequestRec>();
  final rq = req.ref;
  rq.typeAsInt = FT_Size_Request_Type_.FT_SIZE_REQUEST_TYPE_REAL_DIM.value;
  rq.width = 0;
...
typedef GlyphCallback = void Function(Pointer<FT_GlyphSlotRec> glyph);
